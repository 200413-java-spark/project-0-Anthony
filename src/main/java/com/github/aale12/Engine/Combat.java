...
public class Combat {
  ...
  public static void PlayerDefend(PlayerCharacter Player, NonPlayerCharacter Enemy) {
    ...
    System.out.println("> You recieve brace yourself and receive " + Enemy.getAttack() + " damage!");
  }
  ...
  public static void PlayerFlee(PlayerCharacter Player, NonPlayerCharacter Enemy) {
    ...
    Player.setHealth(Player.getHealth() - Enemy.getAttack() * 2);
    System.out.println(Enemy.getName() + " attacks you from behind for " + Enemy.getAttack() * 2 + "damage!");
    System.out.println("You run away into another enemy!");
  }
}
